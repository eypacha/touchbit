...
<template>
  ...
  >
    <SwitchThumb
      :class="
        cn(
          'pointer-events-none block h-5 w-5 border-foreground-muted border rounded-full bg-background shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5',
        )
      "
    >
      <slot name="thumb" />
